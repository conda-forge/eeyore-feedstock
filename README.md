...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eeyore-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13764&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eeyore-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eeyore` can be installed with:

```
conda install eeyore
```

It is possible to list all of the versions of `eeyore` available on your platform with:
